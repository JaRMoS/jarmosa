...
public class WebModelManager extends jarmos.io.WebModelManager {
	...
	public ClassLoader getClassLoader() {
		try {
			...
			Log.e("WebModelManager", "I/O Exception during input stream creation for file " + Const.DEX_CLASSES_JARFILE
					+ " in model " + getModelDir() + ", loading from web location " + this.getModelURI(), e);
			e.printStackTrace();
			return null;
		}
	}
